...
// https://github.com/dotnet/aspire/blob/5238a7355d1d893e0c95c3d83c53471a038a6c37/src/Shared/VolumeNameGenerator.cs
    ...
    public static string CreateVolumeName<T>(IResourceBuilder<T> builder, string suffix) where T : IResource
    {
        if (!HasOnlyValidChars(suffix))
        {
            throw new ArgumentException(
                $"The suffix '{suffix}' contains invalid characters. Only [a-zA-Z0-9_.-] are allowed.", nameof(suffix));
        }
